    ...
    this.collections = [
      {
        ...
        items: [...this.getAllProducts()]
          .sort((a, b) => (a.price * (1 - (a.discountPercentage || 0)/100)) - (b.price * (1 - (b.discountPercentage || 0)/100)))
          .slice(0, 6),
      ...
      },
      {
        ...
        items: [...this.getAllProducts()]
          ...
          .slice(0, 6),
        image: 'https://images.unsplash.com/photo-1608506375591-b91b98fe3189?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80'
      },
      {
